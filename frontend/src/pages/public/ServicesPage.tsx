  ...
  return (
    <div className="container py-10 md:py-14">
      ...
      <div className="grid gap-8 lg:grid-cols-[260px_1fr]">
       ...
       {/* BIDDING DISCOVERY BANNER */}
       <div className="mt-12 rounded-2xl border border-dashed border-border bg-muted/20 p-6 text-center">
         <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center sm:gap-6">
           <span className="flex items-center justify-center gap-1.5">
             <span>💰</span>
             <span className="font-medium">Want a better price?</span>
           </span>
           <Link
             to={ROUTES.biddingHome}
             className="inline-flex items-center gap-1 text-sm font-semibold text-primary hover:underline"
           >
             Request bids from workers →
           </Link>
         </div>
         <p className="mt-2 text-center text-xs text-muted-foreground">
           Post your job and let verified pros compete for your project.
         </p>
       </div>
