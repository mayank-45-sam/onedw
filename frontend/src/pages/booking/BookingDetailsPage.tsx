...
import {
  ...
  Phone, XCircle, Loader2, CheckCircle2, Circle, Camera, BadgeCheck, Hash, ArrowRight,
} from 'lucide-react';
...
import { advanceBooking, getNextBookingAction } from '@/utils/bookingActions';
              ...
              <div className="space-y-2">
                {user?.role === 'worker' &&
                  (() => {
                    ...
                    return (
                      <Button
                        className="btn-glow w-full gap-2 rounded-xl"
                        onClick={() => progressMutation.mutate(action.nextStatus)}
