...
import { BiddingProvider } from '@/features/bidding';
...
const AdminBroadcastsPage     = lazy(() => import('@/pages/dashboard/AdminBroadcastsPage'));
...
const BiddingMarketplacePage = lazy(() => import('@/pages/bidding/BiddingMarketplacePage'));
const WorkerMarketplacePage = lazy(() => import('@/pages/bidding/WorkerMarketplacePage'));
...
function MarketplaceRouter() {
  const { user } = useAuth();
  if (user?.role === 'worker') {
    return <Suspense fallback={fallback}><WorkerMarketplacePage /></Suspense>;
  }
  return <Suspense fallback={fallback}><BiddingMarketplacePage /></Suspense>;
}
  ...
  return (
    <Routes>
      ...
      <Route element={<AuthLayout />}>
        ...
        <Route path={ROUTES.reset}    element={<Suspense fallback={fallback}><ResetPasswordPage /></Suspense>} />
      ...
      <Route element={<ProtectedRoute><DashboardLayout /></ProtectedRoute>}>
        ...
        <Route path={ROUTES.adminBroadcasts}     element={<Suspense fallback={fallback}><AdminBroadcastsPage /></Suspense>} />
      ...
      <Route path={ROUTES.booking}        element={<ProtectedRoute><Suspense fallback={fallback}><BiddingProvider><BookingPage /></BiddingProvider></Suspense></ProtectedRoute>} />
      ...
      <Route path={ROUTES.biddingHome} element={<ProtectedRoute><MarketplaceRouter /></ProtectedRoute>} />
      <Route path={ROUTES.myJobs} element={<ProtectedRoute><MarketplaceRouter /></ProtectedRoute>} />
