...
export const API_ENDPOINTS = {
  ...
  bookings: {
    ...
    create: '/bookings',
    instant: '/bookings/instant',
    nearbyWorkers: '/bookings/nearby-workers',
  ...
  admin: {
    ...
    resendBroadcast: (id: string) => `/admin/broadcasts/${id}/resend`,
  },
  search: {
    query: '/search',
  ...
  bidding: {
    jobs: '/bidding/jobs',
    userJobs: (userId: string) => `/bidding/jobs/user/${userId}`,
    jobDetail: (jobId: string) => `/bidding/jobs/${jobId}`,
    jobBids: (jobId: string) => `/bidding/jobs/${jobId}/bids`,
    submitBid: (jobId: string) => `/bidding/jobs/${jobId}/bids`,
    acceptBid: (bidId: string) => `/bidding/bids/${bidId}/accept`,
    jobMessages: (jobId: string) => `/bidding/jobs/${jobId}/messages`,
    sendMessage: (jobId: string) => `/bidding/jobs/${jobId}/messages`,
  },
} as const;
