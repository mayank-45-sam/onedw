  ...
  'inline-flex items-center gap-1 rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        destructive:
          'border-transparent bg-error text-error-foreground hover:bg-error/85 shadow-sm',
        outline:
          'border-border/60 text-foreground bg-background hover:border-primary/40 hover:text-primary',
        success:
