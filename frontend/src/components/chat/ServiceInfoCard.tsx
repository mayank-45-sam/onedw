...
const costData: Record<ServiceCategory, CostBreakdown> = {
  ...
  pest_control: {
    rows: [
      { label: 'Visit Charge', value: '₹299' },
      { label: 'Treatment', value: '₹400 – ₹1,000' },
      { label: 'Chemicals / Bait', value: '₹200 – ₹800' },
    ],
    total: '₹899 – ₹2,099',
  },
  painting: {
    rows: [
      { label: 'Inspection & Quoting', value: '₹299' },
      { label: 'Paint + Labour', value: '₹1,500 – ₹7,000' },
      { label: 'Prep / Putty / Primer', value: '₹300 – ₹1,000' },
    ],
    total: '₹2,099 – ₹8,299',
  },
};
...
const timeEstimates: Record<ServiceCategory, string> = {
  ...
  pest_control: '45 mins to 2 hours depending on treatment',
  painting: 'Half day to 3 days depending on area',
};
