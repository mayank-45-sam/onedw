  ...
  if (sent) {
    return (
      <div className="text-center">
        ...
        <p className="mt-2 text-muted-foreground">We sent a reset link to your inbox. It expires in 15 minutes.</p>
        <Link to={ROUTES.login} className="mt-6 inline-flex items-center gap-1.5 text-sm font-medium text-primary">
