...
CATEGORY_IMAGES = {
    ...
    "ac-repair": [
        ...
        f"{_U}/photo-1523362628745-0c100fc988ac?{_Q}",
    ...
    "carpentry": [
        ...
        f"{_U}/photo-1558997519-8e4e6e5f2f2f?{_Q}",
        f"{_U}/photo-1504307651254-35680f356dfd?{_Q}",
    ...
    "gardening": [
        ...
        f"{_U}/photo-1463320726281-bf6d0d073f4e?{_Q}",
        f"{_U}/photo-1558618666-fcd25c85f82e?{_Q}",
        f"{_U}/photo-1513694203232-719a280e022f?{_Q}",
    ],
    "beauty-at-home": [
    ...
    "pet-care": [
        ...
        f"{_U}/photo-1548199971-1d300708a1ef?{_Q}",
    ...
    "car-wash": [
        f"{_U}/photo-1520340356584-f9917d7ed2f5?{_Q}",
